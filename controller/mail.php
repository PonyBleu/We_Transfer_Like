...
if(isset($_POST['submit'])){
    ...
    $message = "<span style='color : #003752'><span style='font-size : 30px'>Wetransfer Like</span></span>" . "<br><br>" .$name . "<br>" . $from . "<br>" . "<span style='color : #0078b8'><span style='font-family : Helvetica'> Vous a transmis un fichier, pour le télécharger </span></span><a href='http://romaneh.marmier.codeur.online/We_Transfer_Like/download/$lastIdFichier'><span style='color : #003752'><span style ='font-size : 20px'>cliquez ici</span></span></a> " . "\n\n" . $_POST['article'];
    $message2 = "<span style='color : #003752'><span style='font-size : 30px'>Wetransfer Like</span></span>" . "<br><br>" . "Copie de votre message pour : " . "<br>" . $name . "<br>" . $_POST['article'] . "<span style='color : #0078b8'><span style='font-family : Helvetica'> Vous avez transmis un fichier, pour le télécharger </span></span><a href='http://romaneh.marmier.codeur.online/We_Transfer_Like/download/$lastIdFichier'><span style='color : #003752'><span style ='font-size : 20px'>cliquez ici</span></span></a> ";
