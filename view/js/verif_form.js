...
//console.log("pouet");
						            ...
						            var nomalerte  = "<div id='nomalerte' style='display:block'>Veuillez entrer votre Nom !</div>";
									var mailalerte  = "<div id='mailalerte' style='display:block'>Veuillez entrer votre email !</div>";
									var maildestalerte  = "<div id='maildestalerte' style='display:block'>Veuillez entrer l'email du destinataire !</div>";
									var fichieralerte  = "<div id='fichieralerte' style='display:block'>Veuillez selectionner votre fichier !</div>";
