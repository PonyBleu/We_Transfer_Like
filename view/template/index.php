...
<head>
    ...
    <link rel="stylesheet" href="<?= WEBROOT ?>/view/css/style.css"/>
...
<body >
            ...
            <nav class="cyan lighten-4">
                ...
                <div class="nav-wrapper">
                    ...
                    <ul id="nav-mobile" class="left hide-on-med-and-down">
                        ...
                        <li><img id="logo" src="<?= WEBROOT ?>/view/img/Logo.png"/></li>
    ...
    <footer>
        ...
        <ul id="slide-out" class="side-nav">
            <li><i><a href="#"><img src="<?= WEBROOT ?>/view/img/Outlook.png"></a></i><a href="https://outlook.live.com">Outlook</a></li>
            <li>
                <div class="divider"></div>
            </li>
            <li><i><a href="#"><img src="<?= WEBROOT ?>/view/img/gmail.png"></a></i><a href="https://mail.google.com">GMail</a></li>
        </ul>
    ...
    <script type="text/javascript" src="<?= WEBROOT ?>/view/js/verif_form.js"></script>
